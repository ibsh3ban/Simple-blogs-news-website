                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <label for="example-img-input" class="col-sm-2 col-form-label">Edit Image</label>
                                <div class="col-sm-10">
                                ...
                                <div class="col-sm-10">
                                 ...
                                 src="{{asset('$multiImage->multi_image')}}" alt="No image selected !!">
                                 </div>
                            </div>

              <input type="submit" class="btn btn-outline-info" value="Update About Multi Image">
            </form>
